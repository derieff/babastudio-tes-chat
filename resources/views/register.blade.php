                        ...
                        <div class="login-form">
                            <form action="{{ url('process-register') }}" method="post">
                                ...
                                <div class="input-group">
			                        <div class="form-line">
			                            <input type="text" class="form-control" name="name" placeholder="Nama Lengkap" required autofocus autocomplete="new-name">
			                        </div>
			                    </div>
			                    <div class="input-group">
			                        <div class="form-line">
                                ...
                                <div class="input-group">
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="conf_password" placeholder="Konfirmasi Password" required autocomplete="new-conf-password">
                                    </div>
                                </div>
			                    <div class="input-group">
                                    <button type="submit" class="btn btn-success" id="button-register">
                                        <i class="fa fa-send"></i> REGISTER
                                    </button>
                                </div>
                                <br>
                                <a href="{{ url('form-login') }}">
                                	Sudah punya akun?
                                </a>
                            </form>
                        </div>
